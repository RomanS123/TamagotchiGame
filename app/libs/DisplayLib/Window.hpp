...
template <typename Renderer>
void Window<Renderer>::AddComponent(std::string&& component_name,
                                    Component<Renderer>* component) {
  mapping_[component_name] = component;
}

template <typename Renderer>
Component<Renderer>* Window<Renderer>::GetComponent(
